...
export default function Contact(): ReactElement {
  return (
    <TextContainer>
      ...
      <ul>
        <li>
          <Link href="http://ca.linkedin.com/in/denis-declercq-bb6b298">
            LinkedIn
          </Link>
        </li>
        <li>
          <Link href="http://www.viadeo.com/p/0021epf6mkaedrhk">
            Viadeo
          </Link>
        </li>
        <li>
          <Link href="http://plus.google.com/u/0/+DenisDECLERCQ">
            Google+
          </Link>
        </li>
      </ul>
